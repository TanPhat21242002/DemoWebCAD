...
window["getVisualizeLibInst"] = function getVisualizeLibInst(params) {
	...
	if (params.onprogress) {
		var wasmResponse = downloadWasm(Module["locateFile"](), params.onprogress);
	...
	var STACK_BASE = 8717472;
	var INITIAL_INITIAL_MEMORY = Module["INITIAL_MEMORY"] || 16777216;
	if (Module["wasmMemory"]) {
		wasmMemory = Module["wasmMemory"];
	} else {
		wasmMemory = new WebAssembly.Memory({ initial: INITIAL_INITIAL_MEMORY / WASM_PAGE_SIZE, maximum: 4294967296 / WASM_PAGE_SIZE });
	}
	if (wasmMemory) {
