...
import { ACTION_ENTITY, ACTION_MODIFY, CMD_NAME, DrawingConfig, ENTITY_NAME } from "../config";
...
export class EntityCmd implements IBaseCmd, IEntityAction, IEntityProp, IEntityEvent, ICmdEvent {
	...
	modifySize(arr: any, pointWorld: any) {
		throw new Error("Method not implemented.");
	}

	modifyPosition(arr: any, pointWorld: any) {
		this.move(arr);
	}
	...
	onMouseDown = (ev: MouseEvent, pointOxy: any, pointWorld: any) => {
		//DO NOTHING IF SPECIFY CMD LIKE CIRCLE, RECTANGLE ...
	...
	onMouseUp = (ev: MouseEvent, pointOxy: any, pointWorld: any) => {
